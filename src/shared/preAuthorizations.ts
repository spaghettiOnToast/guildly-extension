...
export const preAuthorize = async (account: BaseGuildAccount, host: string) => {
...
export const useIsPreauthorized = (
  ...
  return all.some(
    (x) => account && equalPreAuthorization(x, { account, host })
  );
};
